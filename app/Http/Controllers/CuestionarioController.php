...
class CuestionarioController extends Controller
{
    ...
    {   
        if(session('periodo') == 1){
            ...
            return view('cuestionario.encuesta2020',[
            ...
            return view('cuestionario.encuesta2020bis',[
                'preguntas'=> C_Pregunta::all(),
                'estados'=> C_Estado::all(),
                'colonias'=> C_Colonia::all(),
                'localidades'=> C_Localidad::findMany([57,249]),   
    ...
    {   
        if(session('periodo') == 1){ //20202
            ...
            return view('cuestionario.encuestaUpdate2020',[
                'preguntas'=> C_Pregunta::all(),
                'estados'=> C_Estado::all(),
                'alimentos'=> C_Alimento::all(),
                'estudios'=> C_GradoDeEstudio::all(),
            ...
            return view('cuestionario.encuestaUpdate2020bis',[
                'preguntas'=> C_Pregunta::all(),
                'estados'=> C_Estado::all(),
                'colonias'=> C_Colonia::all(),
                'localidades'=> C_Localidad::findMany([57,249]),   
    ...
    public function imprimir($id){
        ...
        if(session('periodo') == 1){//2020
            ...
            $pdf = \PDF::loadView('cuestionario.formato2020', compact('preguntas','persona','estados','alimentos','estudios','ss','violencias','materiales','colonias','localidades','municipios','gruposociales','estadosCiviles'));
            ...
            $pdf = \PDF::loadView('cuestionario.formato2020bis', compact('preguntas','persona','estados','colonias','localidades','municipios','estadosCiviles','estudios'));
            $pdf->setPaper('letter', 'portrait');
            return $pdf->stream("Cuestionario.pdf");//, array("Attachment" => 0)); 
            // return $pdf->download('Cuestionario.pdf');
        }
