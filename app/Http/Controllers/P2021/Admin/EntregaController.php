...
class EntregaController extends Controller
{
    ...
    public function findEntregas($id){//listo
        ...
        ->select('entregas.*', 'c_periodos.Descripcion as periodo', 'users.name','c_municipios.Descripcion as municipio','c_localidades.Descripcion as localidad')
    ...
    public function editarEntrega($id){   
        if(session('periodo') == 1){ //2020
            ...
            return view('2020.entregas.entregaUpdate2020',[
            ...
            return view('2020.entregas.entregaUpdate2020bis',[
                'preguntas'=> C_Pregunta::all(),
                'estados'=> C_Estado::all(),
                'colonias'=> C_Colonia::all(),
                'localidades'=> C_Localidad::findMany([57,249]),   
