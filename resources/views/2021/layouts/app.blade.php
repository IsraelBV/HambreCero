    ...
    <script> //se utiliza para cuestionario
        ...
        $(document).ready(function() {
            ...
            $("#solicitarD").off().click(function(){
                ...
                documentoshtml +='      <input type="file" class="custom-file-input" id="IdentificacionFile" name="IdentificacionFile" lang="es">';
                documentoshtml +='      <label class="custom-file-label" for="IdentificacionFile">Seleccionar Identificacion</label>';
                ...
                // $('#encuestaupdatemodal [data-btn="cpt"]').off().click(function(){
                    
                //     $.ajax({
                //         type: "POST",
                //         url: "/registro/Entrega/solicitar/"+$("#ntn").data('persona'),
                //         data: $("#documentosForm").serialize(),
                //         success: function(data) {
