...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-around">
            <a style="position: fixed; top: 10%; left: 10px;"  id="btnreturn" href="/2022/registro" class="btn btn-dark" role="button" aria-pressed="true"><strong><span style="font-size: 1.5rem">&#8592; </span> Salir</strong></a>
        </div>
    </div>
